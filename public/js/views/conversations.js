        ...
        <div class="wa-conversations-panel" id="wa-conv-panel">
          ...
          <div class="wa-search">
            <div class="wa-search__input-wrap">
              ...
              <input type="text" class="wa-search__input" id="conv-search" placeholder="Buscar por nombre o teléfono" autocomplete="off">
            </div>
          </div>
  ...
  function renderMessages() {
    ...
    for (const msg of state.messages) {
      ...
      if (isOut) {
        ...
        const contactName = (msg.contact && msg.contact.name) || state.activeConv?.contact?.name;
        const contactPhone = state.activeConv?.phone || (msg.contact && msg.contact.phone);
        author = contactName || (contactPhone ? formatPhone(contactPhone) : 'Contacto');
      }
